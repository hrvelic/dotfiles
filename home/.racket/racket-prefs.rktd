(
 (|plt:DrRacket 7.7-splash-max-width| 1001)
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:other #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (248 225 170) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:keyword #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (231 158 60) (0.0 0.0 0.0) 0 1 italic base #t #f base bold))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:parenthesis #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (165 205 29) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 (plt:framework-pref:color-scheme-entry:drracket:read-eval-print-loop:out-color #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (239 192 144) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:misspelled-text-color #hash((white-on-black . #4(248 225 170 1.0))))
 ...
 (plt:framework-pref:framework:standard-style-list:font-name "Droid Sans Fallback")
 ...
 (plt:framework-pref:color-scheme-entry:drracket:check-syntax:their-obligation-style-pref #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (219 255 250) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:string #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (244 224 72) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:constant #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (214 194 72) (0.0 0.0 0.0) 0 1 italic base #t #f base bold))))
 (plt:framework-pref:framework:ask-about-paste-normalization #t)
 (plt:framework-pref:color-scheme-entry:drracket:check-syntax:my-obligation-style-pref #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (219 255 250) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:drracket:check-syntax:lexically-bound #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (248 225 170) (0.0 0.0 0.0) 0 1 italic base #t #f base bold))))
 (plt:framework-pref:color-scheme-entry:drracket:read-eval-print-loop:value-color #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (214 194 72) (0.0 0.0 0.0) 0 1 italic base #t #f base bold))))
 ...
 (plt:framework-pref:color-scheme-entry:drracket:check-syntax:free-variable #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (248 225 163) (0.0 0.0 0.0) 0 1 base italic #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:default-text-color #hash((white-on-black . #4(248 225 170 1.0))))
 (plt:framework-pref:framework:last-directory #"/home/hrvoje/")
 (|plt:framework-pref:SyntaxBrowser:DisplayTaintIcons| char)
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:text #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (248 225 170) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 (plt:framework-pref:framework:show-status-line #t)
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:symbol #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (233 93 11) (0.0 0.0 0.0) 0 1 base normal #t #f base bold))))
 ...
 (plt:framework-pref:color-scheme-entry:drracket:check-syntax:set!d #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (248 225 163) (0.0 0.0 0.0) 0 1 base italic #f #t base base))))
 ...
 (plt:framework-pref:color-scheme-entry:drracket:check-syntax:imported #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (239 192 144) (0.0 0.0 0.0) 0 1 italic base #t #f base bold))))
 (plt:framework-pref:color-scheme-entry:framework:basic-canvas-background #hash((white-on-black . #4(26 26 26 1.0))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:comment #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (131 120 110) (0.0 0.0 0.0) 0 1 base normal #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:drracket:check-syntax:unk-obligation-style-pref #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (161 147 135) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:drracket:check-syntax:unused-require #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (128 128 128) (0.0 0.0 0.0) 0 1 base italic #t #f base base))))
 ...
 (plt:framework-pref:color-scheme-entry:framework:syntax-color:scheme:hash-colon-keyword #hash((white-on-black . (base base (0 0 0) (1 1 1) #f base (219 255 250) (0.0 0.0 0.0) 0 1 italic base #t #f base base))))
 ...
 (plt:framework-pref:drracket:gui-installer-pkg-source "drracket-vim-tool")
 (plt:framework-pref:drracket:vim-emulation? #t)
 (|plt:DrRacket 7.9-splash-max-width| 1006)
 ...
 (plt:framework-pref:drracket:window-position #hash((#f . (0 0 25)) (((0 0 1920 1080)) . (0 0 25)) (((-1920 0 2560 1440) (0 0 1920 1080) (-4480 0 1920 1200)) . (0 433 182))))
 (plt:framework-pref:framework:exit-when-no-frames #t)
 (plt:framework-pref:framework:standard-style-list:font-size #2(#hash((((2560 1440) (1920 1080) (1920 1200)) . 14) (((1920 1080)) . 14)) 14))
 (plt:framework-pref:framework:color-scheme white-on-black)
 (plt:framework-pref:plt:debug-tool:stack/variable-area 9/10)
 (plt:framework-pref:drracket:most-recent-lang-line "#lang slideshow\n")
 (plt:framework-pref:drracket:unit-window-size-percentage 1/2)
 (plt:framework-pref:drracket:window-size #hash((#f . (#t 1920 494)) (((0 0 1920 1080)) . (#t 1920 494)) (((-1920 0 2560 1440) (0 0 1920 1080) (-4480 0 1920 1200)) . (#t 600 650)) (((0 0 2560 1440) (0 -1440 1920 1080) (-2560 0 1920 1200)) . (#t 1920 494))))
